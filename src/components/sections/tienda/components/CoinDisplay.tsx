      ...
      >
        ...
        {user && (
          <button
            ...
            className="ml-1 flex h-7 w-7 items-center justify-center rounded-xl bg-warning/20 text-warning border border-warning/30 hover:bg-warning/30 active:scale-95 transition-all duration-150"
